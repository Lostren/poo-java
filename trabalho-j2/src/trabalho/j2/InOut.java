...
public class InOut {
        ...
        private static Icon currentIcon = null;
	...
	public static String leString (String frase){
            ...
            Entrada = (String) JOptionPane.showInputDialog(null, frase, "Entrada de dados", JOptionPane.QUESTION_MESSAGE, currentIcon, null, null);
            resetIcon();
            return Entrada;
        }
	...
	public static void MsgDeErro(String cabecalho, String frase){
            JOptionPane.showMessageDialog(null, frase, cabecalho,  JOptionPane.ERROR_MESSAGE, currentIcon);
            resetIcon();
        }
	...
	public static void MsgDeInformacao(String cabecalho, String frase){
            JOptionPane.showMessageDialog(null, frase, cabecalho, JOptionPane.INFORMATION_MESSAGE, currentIcon);
            resetIcon();
        }
	/**
	...
	public static void MsgSemIcone(String cabecalho, String frase){
            JOptionPane.showMessageDialog(null, frase, cabecalho, JOptionPane.PLAIN_MESSAGE, currentIcon);
            resetIcon();
        }
	...
	public static void MsgDeAviso (String cabecalho, String frase){
            JOptionPane.showMessageDialog(null, frase, cabecalho, JOptionPane.WARNING_MESSAGE, currentIcon);
            resetIcon();
        }
